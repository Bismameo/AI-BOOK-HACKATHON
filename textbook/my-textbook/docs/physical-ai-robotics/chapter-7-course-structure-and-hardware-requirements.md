# Chapter 7: Course Structure and Hardware Requirements

This course is designed to provide a comprehensive understanding of Physical AI and Humanoid Robotics. It combines theoretical knowledge with practical implementation, leveraging powerful simulation tools and real-world hardware.

## Assessments

To ensure a thorough learning experience and practical proficiency, the course includes the following assessments:

-   **ROS 2 package development project:** Students will develop a functional ROS 2 package, demonstrating their ability to utilize ROS 2 for robot control and communication.
-   **Gazebo simulation implementation:** A project focused on implementing and testing robot behaviors within the Gazebo simulation environment, showcasing physics simulation, sensor integration, and control.
-   **Isaac-based perception pipeline:** Development of a perception pipeline using NVIDIA Isaac tools, focusing on tasks such as object detection, segmentation, or SLAM.
-   **Capstone: Simulated humanoid robot with conversational AI:** The culminating project where students integrate all learned concepts to create a simulated humanoid robot capable of performing tasks and interacting conversationally within a virtual environment.
