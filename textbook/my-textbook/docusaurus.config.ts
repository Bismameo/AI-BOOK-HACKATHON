...
const config: Config = {
  ...
  tagline: 'Embark on a journey into embodied intelligence',
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} AI-BOOK-HACKATHON, Inc. Built with Docusaurus.`,
    },
    prism: {
